...
# Mostrar la visualización de basurales
...
folium.GeoJson(gdf_basurales).add_to(mapa_basurales)

# Añadir zonas AOI para predicción
folium.GeoJson(gdf_aoi_predict, style_function=lambda x: {'color': 'green'}).add_to(mapa_basurales)
